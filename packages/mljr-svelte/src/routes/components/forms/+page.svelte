<script lang="ts">
  ...
  const inputProps = [
    ...
    { name: '...restProps', type: 'HTMLInputAttributes', default: '—', description: 'All standard input attributes (type, placeholder, disabled, maxlength, etc.).' },
  ];
