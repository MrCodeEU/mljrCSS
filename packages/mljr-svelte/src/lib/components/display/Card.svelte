<script lang="ts">
  ...
  type CardVariant = 'default' | 'primary' | 'secondary' | 'accent' | 'success' | 'warning' | 'error' | 'danger' | 'info';
  ...
  const variantClasses: Record<CardVariant, string> = {
    ...
    accent: 'mljr-card-accent',
    success: 'mljr-card-success',
    warning: 'mljr-card-warning',
    error: 'mljr-card-error',
    danger: 'mljr-card-danger',
    info: 'mljr-card-info',
  };
