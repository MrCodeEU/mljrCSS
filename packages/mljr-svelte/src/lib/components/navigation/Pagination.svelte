...
<div class="mljr-pagination-wrapper">
  ...
  {#if showJumpTo || showItemsPerPage}
    <div class="mljr-pagination-controls">
      {#if showItemsPerPage}
        <div class="mljr-pagination-per-page">
          <label for="items-per-page" class="mljr-pagination-label">Items per page:</label>
          <select
            id="items-per-page"
            class="mljr-select mljr-select-sm"
            value={itemsPerPage}
      ...
      {#if showJumpTo}
        <div class="mljr-pagination-jump">
          <label for="jump-to-page" class="mljr-pagination-label">Go to page:</label>
          <input
            id="jump-to-page"
            type="number"
            min="1"
            ...
            class="mljr-input mljr-input-sm mljr-pagination-jump-input"
            placeholder={currentPage.toString()}
          />
          <button
            onclick={handleJumpTo}
            class="mljr-btn mljr-btn-sm mljr-btn-primary"
